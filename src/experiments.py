...
def initialize_model_directory(args, random_seed=None):
    ...
    """
    使用不同的embedding模型，rule， point， distmult， complex， conve， hypere, triplee对应加载不同的参数
    """
...
def construct_model(args):
    """
    Construct NN graph.
    根据不同的模型选择相应的 policy network和 learn_framework
    """
...
def train(lf):
    ...
    # 添加了reverse的关系 add_reverse_relations=args.add_reversed_training_edges
...
def compute_fact_scores(lf):
    ...
    # def forward_fact(self, examples): 计算scores
